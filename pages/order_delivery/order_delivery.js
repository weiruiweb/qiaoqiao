import {
 ...
 Page({
 	...
 	pay(order_id) {
 		...
 		if (self.data.distributionData && self.data.distributionData.userInfo[0] && self.data.distributionData.userInfo[0]
 			.level && self.data.distributionData.userInfo[0].level == 1) {
 			postData.payAfter.push({
 				tableName: 'FlowLog',
 				FuncName: 'add',
 				data: {
 		...
 		if (self.data.distributionData && self.data.distributionData.userInfo[0] && self.data.distributionData.userInfo[0]
 			.level && self.data.distributionData.userInfo[0].level == 2) {
 			postData.payAfter.push({
 				tableName: 'FlowLog',
 				FuncName: 'add',
 				data: {
